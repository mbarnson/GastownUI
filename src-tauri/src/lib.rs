...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            voice::check_voice_model_status,
            voice::get_voice_model_info,
            voice::check_disk_space,
            voice::prepare_voice_model_directory,
            voice::make_server_executable,
